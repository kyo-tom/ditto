...
execStatement
    : queryStatementExpression          #query
    | loadStatement                     #load
    | exportStatement                   #export
    | importStatement                   #importDefault
    | replDumpStatement                 #replDump
    | replLoadStatement                 #replLoad
    | replStatusStatement               #replStatus
    | ddlStatement                      #ddl
    | deleteStatement                   #delete
    | updateStatement                   #update
    | sqlTransactionStatement           #sqlTransaction
    | mergeStatement                    #merge
    | refreshStatement                  #refresh
    ;
...
tableRowNullFormat
    ...
    ;
tableFileFormat
    : KW_STORED KW_AS KW_INPUTFORMAT StringLiteral KW_OUTPUTFORMAT StringLiteral (KW_INPUTDRIVER StringLiteral KW_OUTPUTDRIVER StringLiteral)?  #fileFormatAll
      | KW_STORED KW_BY StringLiteral
         (KW_WITH KW_SERDEPROPERTIES tableProperties)?      #fileFormatBy
      | KW_STORED KW_AS identifier      #fileFormatAs
    ;
...
columnNameTypeConstraint
    : identifier colType (KW_NOT KW_NULL)? columnConstraint? (KW_COMMENT StringLiteral)?
    ;

columnConstraint
    : ( foreignKeyConstraint )              #foreignKeyConstraintRule
    | ( colConstraint )                     #colConstraintRule
    ;
...
insertClause
    ...
    | KW_INSERT KW_OVERWRITE KW_TABLE? tableOrPartition (LPAREN columnNameList RPAREN)?
